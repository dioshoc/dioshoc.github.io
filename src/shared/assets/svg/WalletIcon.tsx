...
export const WalletIcon = (args: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
    <svg width="24" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" {...args}>
      <defs>
        <mask id="wallet-icon-mask" maskUnits="userSpaceOnUse" x="0" y="0" width="100%" height="100%">
        ...
        <linearGradient id="lianer-gradient" x1="8" y1="4" x2="19" y2="20" gradientUnits="userSpaceOnUse">
      ...
      <g mask="url(#wallet-icon-mask)">
        ...
        <rect id="gradient" x="0" y="0" width="100%" height="100%" fill="url(#lianer-gradient)"/>
      </g>
    </svg>
  )
}